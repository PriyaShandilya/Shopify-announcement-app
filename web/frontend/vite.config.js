...
const proxyOptions = {
  ...
  // 1. MUST be true so the proxy rewrites the origin header to match the backend target host
  changeOrigin: true, 
  // 2. MUST be false because your local 127.0.0.1 server does NOT use a real SSL certificate
  secure: false,      
  ws: false,
};
